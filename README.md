...
<!-- - (DONE )Get a list of books & render them
  `GET http://localhost:3000/books` -->
<!-- - (DONE) Be able to click on a book, you should see the book's thumbnail and description and a list of users who have liked the book. You can get this information by making another fetch `GET http://localhost:3000/books/:id` -->
